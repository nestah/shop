...
export default function PlaceOrderScreen(props) {
  ...
  cart.totalPrice = toPrice((cart.itemsPrice  + cart.shippingPrice + cart.taxPrice)*(0.0096154));
            ...
            <li>
              <div className="card card-body">
                ...
                <p>
                  ...
                  <p>
                  <strong>PickingPoint: </strong> {cart.shippingAddress.PickingPoint},
            ...
            <ul>
              ...
              <li>
                <div className="row">
                  ...
                  <div>
                    <strong>ksh{cart.total.toFixed(2)}</strong>
                  </div>
                </div>
              </li>
              <li>
